...
$NUnitTestAssemblyPaths = @(
    "Src\Roflcopter.Plugin.Tests\bin\RD20203\$Configuration\Roflcopter.Plugin.Tests.RD20203.dll"
    "Src\Roflcopter.Plugin.Tests\bin\RS20203\$Configuration\Roflcopter.Plugin.Tests.RS20203.dll"
)
