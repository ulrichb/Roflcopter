...
$NUnitTestAssemblyPaths = @(
    "Src\Roflcopter.Plugin.Tests\bin\RD20193\$Configuration\Roflcopter.Plugin.Tests.RD20193.dll"
    "Src\Roflcopter.Plugin.Tests\bin\RS20193\$Configuration\Roflcopter.Plugin.Tests.RS20193.dll"
)
